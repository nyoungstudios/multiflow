...
class TestFlowFlowBase(TestFlowBase):
    ...
    def test_flow_upstream_error(self):
        ...
        with MultithreadedFlow(quiet_traceback=True) as flow:
            ...
            last_success_count = flow.get_successful_job_count(last=True)
            last_failed_count = flow.get_failed_job_count(last=True)
            success_count0 = flow.get_successful_job_count(fn_id=0)
            failed_count0 = flow.get_failed_job_count(fn_id=0)
            success_count1 = flow.get_successful_job_count(fn_id=1)
            failed_count1 = flow.get_failed_job_count(fn_id=1)
            success_count2 = flow.get_successful_job_count(fn_id=2)
            failed_count2 = flow.get_failed_job_count(fn_id=2)
            success_count3 = flow.get_successful_job_count(fn_id=3)
            failed_count3 = flow.get_failed_job_count(fn_id=3)
        ...
        self.assertEqual(8, success_count0)
        self.assertEqual(0, failed_count0)
        self.assertEqual(7, success_count1)
        self.assertEqual(1, failed_count1)
        self.assertEqual(7, success_count2)
        self.assertEqual(0, failed_count2)
        self.assertEqual(0, success_count3)
        self.assertEqual(0, failed_count3)
    ...
    def test_flow_upstream_branch(self):
        ...
        self.assertEqual(8, success_count0)
        self.assertEqual(0, failed_count0)
        self.assertEqual(8, success_count1)
        self.assertEqual(0, failed_count1)
        self.assertEqual(4, success_count2)
        self.assertEqual(0, failed_count2)
        self.assertEqual(0, success_count3)
        self.assertEqual(0, failed_count3)
